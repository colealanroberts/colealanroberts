...
import { h as getDefaultExportFromCjs } from './chunks/astro/server_CQ8lGaqi.mjs';
...
function requireReactDomServer_edge_production () {
	...
	function createRenderState(
	  ...
	  if (undefined !== bootstrapScripts)
	    for (importMap = 0; importMap < bootstrapScripts.length; importMap++) {
	      var scriptConfig = bootstrapScripts[importMap];
	      idPrefix = inlineScriptWithNonce = undefined;
	      bootstrapScriptContent = {
	        rel: "preload",
	        as: "script",
	        fetchPriority: "low",
	  ...
	  if (undefined !== bootstrapModules)
	    for (
	      ...
	      (bootstrapScriptContent = bootstrapModules[bootstrapScripts]),
	        (inlineScriptWithNonce = maxHeadersLength = undefined),
	        (idPrefix = {
	          rel: "modulepreload",
	          fetchPriority: "low",
	          nonce: nonce
	...
	function createResumableState(
	  ...
	  return {
	    idPrefix: undefined === identifierPrefix ? "" : identifierPrefix,
	    nextFormID: 0,
	    streamingFormat: 0,
	  ...
	  switch (type) {
	    ...
	    case "style":
	      ...
	      if (
	        ...
	        textEmbedded && target$jscomp$0.push(textSeparator);
	        JSCompiler_inline_result$jscomp$6 = undefined;
	      }
	    ...
	    case "img":
	      ...
	      if (
	        ...
	        var sizes = "string" === typeof props.sizes ? props.sizes : undefined,
	          ...
	          0 <= (resumableState.remainingCapacity -= header.length + 2))
	            ...
	            : ((resumableState = []),
	              pushLinkImpl(
	                resumableState,
	                assign(
	                  { rel: "preload", href: imageSrcSet ? undefined : href, as: as },
	                  options
	                )
	              ),
	              "high" === fetchPriority
	...
	function useReducer(reducer, initialArg, init) {
	  ...
	  if (isReRender) {
	    ...
	    if (
	      ...
	      ((init = renderPhaseUpdates.get(queue)), undefined !== init)
	    ) {
	...
	var HooksDispatcher = {
	  ...
	  useDeferredValue: function (value, initialValue) {
	    resolveCurrentlyRenderingComponent();
	    return undefined !== initialValue ? initialValue : value;
	  },
	...
	function RequestInstance(
	  ...
	  this.progressiveChunkSize =
	    undefined === progressiveChunkSize ? 12800 : progressiveChunkSize;
	  this.status = 10;
	  ...
	  this.onError = undefined === onError ? defaultErrorHandler : onError;
	  this.onPostpone = undefined === onPostpone ? noop : onPostpone;
	  this.onAllReady = undefined === onAllReady ? noop : onAllReady;
	  this.onShellReady = undefined === onShellReady ? noop : onShellReady;
	  this.onShellError = undefined === onShellError ? noop : onShellError;
	  this.onFatalError = undefined === onFatalError ? noop : onFatalError;
	  this.formState = undefined === formState ? null : formState;
	}
	    ...
	    if (type.prototype && type.prototype.isReactComponent) {
	      ...
	      if (defaultProps) {
	        ...
	        for (var propName$33 in defaultProps)
	          undefined === newProps[propName$33] &&
	      ...
	      var initialState = undefined !== newProps.state ? newProps.state : null;
	              ...
	              (propName$33 = type[ref]),
	                (propName$33 =
	                  "function" === typeof propName$33
	                    ? propName$33.call(newProps, defaultProps, props, undefined)
	                    : propName$33),
	                null != propName$33 &&
	                  (initialState
	                    ? ((initialState = false),
	      ...
	      type = renderWithHooks(request, task, keyPath, type, props, undefined);
	      if (12 === request.status) throw null;
	      ...
	      switch (node.$$typeof) {
	        case REACT_ELEMENT_TYPE:
	          var type = node.type,
	            ...
	            props = node.props;
	          node = props.ref;
	          var ref = undefined !== node ? node : null,
	...
	reactDomServer_edge_production.renderToReadableStream = function (children, options) {
	  return new Promise(function (resolve, reject) {
	    var onFatalError,
	      ...
	      onHeaders = options ? options.onHeaders : undefined,
	      onHeadersImpl;
	    onHeaders &&
	      (onHeadersImpl = function (headersDescriptor) {
	        onHeaders(new Headers(headersDescriptor));
...
function requireReactDomServerLegacy_browser_production () {
	...
	function pushInnerHTML(target, innerHTML, children) {
	  if (null != innerHTML) {
	    ...
	    innerHTML = innerHTML.__html;
	    null !== innerHTML && undefined !== innerHTML && target.push("" + innerHTML);
	  }
	}
	function flattenOptionChildren(children) {
	  var content = "";
	...
	function endChunkForTag(tag) {
	  var chunk = endTagCache.get(tag);
	  undefined === chunk && ((chunk = "</" + tag + ">"), endTagCache.set(tag, chunk));
	  return chunk;
	}
	function writeBootstrap(destination, renderState) {
	  renderState = renderState.bootstrapChunks;
	        ...
	        "string" === typeof props
	          ...
	          : ((integrity.href = i = props.src),
	            (integrity.integrity = crossOrigin =
	              "string" === typeof props.integrity ? props.integrity : undefined),
	...
	function renderToStringImpl(
	  ...
	  var didFatal = false,
	    ...
	    result = "",
	    readyToStream = false;
	  options = createResumableState(options ? options.identifierPrefix : undefined);
	  children = createRequest(
	    children,
	    options,
